...
function App() {
  ...
  return (
    <main>
      ...
      {showSidebar ? (
        <Sidebar
          myPostComponent={handleSetshowMyPostComponent}
          SearchUserComponent={handleSetSearchUser}
        />
      ) : null}
      {showMyPostComponent ? <UserPostsComponent userName={userName} /> : null}
      {showSearchUser ? <SearchUser userName={userName} /> : null}
